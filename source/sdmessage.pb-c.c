...
static const ProtobufCFieldDescriptor statistics_t__field_descriptors[4] =
{
  {
    "amount",
    1,
  ...
  },
  {
    ...
    0,   /* quantifier_offset */
    offsetof(StatisticsT, microseconds),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_SINT32,
    0,   /* quantifier_offset */
    offsetof(StatisticsT, clients_connected),
    NULL,
    NULL,
    0,             /* flags */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
static const unsigned statistics_t__field_indices_by_name[] = {
  0,   /* field[0] = amount */
  3,   /* field[3] = clients_connected */
  2,   /* field[2] = microseconds */
  1,   /* field[1] = seconds */
};
